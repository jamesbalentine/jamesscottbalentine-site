...
?>
    ...
    <table style="text-align: center; margin-left: auto; margin-right: auto; height: auto; width: 782px; background-color: black;"        cellpadding="10" cellspacing="2">
        <tr>
          <td colspan="3" style="text-align: center; margin-top: 10px; font-family: Palatino; font-size: 14px;">
      ...
      <td style="text-align: justify; vertical-align: top; font-size: 14px; colspan="1" rowspan="3"">
                
      
      <span style="color: white; font-family: Palatino;">
                  <center>His music has been commissioned by soloists and ensembles including:</center>
                <ul>
                  ...
                  <center>Awards, Grants and honors from:</center>
                <ul>
                  ...
                  <center>With performances at:</center>
                <ul>
      ...
      <center>Personal</center><br>
                  ...
                  have inherited three beautiful and amazing daughters-in-law, Angie, Elizabeth, and Ashley, from the families McBride, Pena, and McGee, for whom we are exceedingly grateful. <center>We Balentines have been lucky indeed!</center></span>
      </td>
    </tr>
</table>
<?php

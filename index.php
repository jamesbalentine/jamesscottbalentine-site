...
<html>
	...
	<body style="overflow: hidden;">
		<div style="position: fixed; bottom: 0; left: 0; right: 0; z-index: 1; padding: 10px 0 10px 0; margin: 0; background-color: rgba(0, 0, 0, 0.8); width: 100%; height: 85px;">
			<?php include "inc/audioplayer.php"; ?>
		</div>
		<div id="innerframe-wrapper" style="position: absolute; top: 0; bottom: 105px; left: 0; right: 0;">
